 ...
 */
final class Version20250119175505 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE historique (id INT AUTO_INCREMENT NOT NULL, type_entite VARCHAR(50) NOT NULL, entite_id INT NOT NULL, action VARCHAR(50) NOT NULL, donnees LONGTEXT NOT NULL, user_id INT DEFAULT NULL, date DATETIME NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
